...
var SELinuxEventDetails = React.createClass({displayName: "SELinuxEventDetails",
    render: function() {
        ...
        var fix_entries = this.props.details.plugin_analysis.map(function(itm) {
            ...
            return (
                React.createElement("div", {className: "list-group-item", key:  itm.analysis_id},
                     fixit,
                    React.createElement("div", {className: "list-view-pf-main-info"},
                        React.createElement("div", {className: "list-view-pf-left"},
                            React.createElement("span", null,  itm.if_text)
                        ),
                        React.createElement("div", {className: "list-view-pf-body"},
                            React.createElement("div", {className: "list-view-pf-description"},
                                React.createElement("div", {className: "list-group-item-text"},
                                     itm.then_text
                                )
                            ),
                            React.createElement("div", {className: "list-view-pf-additional-info"},
                                 itm.do_text
                            )
                        )
                    )
        ...
        return (
          React.createElement("div", {className: "list-group list-view-pf"},
               fix_entries
          )
        );
    }
